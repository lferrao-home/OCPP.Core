...
namespace OCPP.Core.Server {
    public partial class ControllerOCPP16 {
        public void HandleRemoteStartTransaction(OCPPMessage msgIn, OCPPMessage msgOut) {
            ...
            try {
                RemoteStartStopTransactionResponse response = JsonConvert.DeserializeObject<RemoteStartStopTransactionResponse>(msgIn.JsonPayload);
                Logger.LogInformation("RemoteStartTransaction => Answer status: {0}", response?.Status);
